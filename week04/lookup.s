...
dealing_with_array:
	...
	mul $t2, $t0, N_COLS	# x*N_COLS
	# gives offset required to access the correct row in the array

	add $t2, $t2, $t1		# x*N_COLS + y
	# gives the index of the desired element within that row

	mul $t2, $t2, 4			# mul with offset(int)
	# make sure alignment error dodesn't error
